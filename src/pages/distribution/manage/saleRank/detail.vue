<template>
  <div>
    <div class="page-title">
      <div class="avatar">
        <img :src="'./static/img/headLogo.jpg'" style="width:90px;height:90px">
        <b style="font-size:14px">Lumasas</b>
      </div>
    </div>
    <div class="pannel pannel-content">
      <span>时间范围：</span>
      <el-date-picker v-model="query.time" size="mini"
    ...
    <div class="pannel current-data">
      <el-tabs type="card">
        <el-tab-pane label="店铺实时数据">
          <ul class="data-list">
            <li>
              <p>销售额</p>
    ...
    <div class="pannel">
      <el-tabs type="card">
        <el-tab-pane label="一级分店">
          <shop-table :list="list"/>
        </el-tab-pane>
        <el-tab-pane label="二级分店" lazy>
          <shop-table :list="list"/>
        </el-tab-pane>
      </el-tabs>
